...
Ein grosses Dankeschön an [jkaltes](https://www.juggluco.nl/) für all die Arbeit. Mit der Juggluco App ist es möglich, die Blutzuckerwerte vom Libre 3 Sensor offline und ohne Root an xDrip+, AndroidAPS etc. zu senden. Eine ausführliche Anleitung findest du hier: [Anleitung Libre 3 Verbindung mit Juggluco](./Juggluco-solution/instructions/de/instructions.md). Hier geht es direkt [zum Download](https://www.juggluco.nl/Juggluco/download.html). Bitte beachte: Das ganze ist auf eigenes Risiko und ohne jegliche Art von Garantie oder Unterstützung. Dieses Projekt hat keine Zusammenarbeit und wird nicht empfohlen von Abbott.
